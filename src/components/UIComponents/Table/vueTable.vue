<template>
  <!--https://jsfiddle.net/xkkbfL3L/9380/-->
        ...
        <tr>
          ...
          <th>
            ...
            <div class="editColumns">
              ...
              />
              <ul :class="{ open: d_editColumns }">
                <li>
                  <label>Display Columns</label>
                </li>
                <li v-for="col in d_columns" :key="col">
                  <label>
                    <input
                      type="checkbox"
                      :value="col"
        ...
        <template v-for="(entry, index) in tableData" :entry="entry">
          <tr
            ...
            :class="{
              selected:
                metadata.selected &&
                metadata.selected.indexOf(entry[select]) != -1,
              tableBgStriped: tableBgStriped_Toggle()
            }"
            :id="entry[select]"
...
export default {
  ...
  methods: {
    ...
    toggleSubTable: function(newValue) {}, //toggleSubTable
