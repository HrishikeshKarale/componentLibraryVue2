<template>
  <div class="productTag">
    <card-background>
      <div class="tag">
        <div class="col1">
          ...
          <div class="divide4" />
          <div class="row2">
            <vue-info label="Available" :value="available" />
            <number-input
              label="Quantity"
              name="Quantity"
    ...
    <div v-if="d_tags" class="divide16" />
    <template v-for="t in d_tags">
      <card-background :key="t.index">
        <div class="tag" :id="t.sku" :key="t.index">
          <div class="col1">
            <div class="row1">
              <div>
                <searchable-dropdown-list
            ...
            <div class="divide4" />
            <div class="row2">
              <vue-info label="Available" :value="t.available" />
              <number-input
                label="Quantity"
                name="Quantity"
                :value="t.quantity"
          ...
          <div class="col2">
            ...
            <div>
              <vue-button
                ...
                :text="d_text"
                :icon="
                  editId && editId == t.sku ? 'fas fa-plus' : 'fas fa-pen-alt'
                "
                :category="d_category[0]"
                :form="d_form"
      ...
      <div v-if="spaceCounter" :key="t.index" class="divide8" />
    </template>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    toggleEdit: function(id) {
      ...
      const index = this.d_tags.findIndex(x => x.sku == id);
      const tag = document.getElementById(id);
      const dropdown = tag.getElementsByTagName("input");
    ...
    spaceCounter: function() {
      ...
      const result = this.totalEmployees - index > 1;
      this.index = index + 1;
      return result;
    } //spaceCounter
  }, //methods
