...
export default Vue.extend({
  name: 'Component_library_vue2Sample', // vue component name
  data(): SampleData {
    return {
      counter: 5,
      initCounter: 5,
...
<template>
  <div class="component_library_vue2-sample">
...
<style scoped>
  ...
  .component_library_vue2-sample p {
    margin: 0 0 1em;
  }
</style>
